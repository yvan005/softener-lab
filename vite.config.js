  ...
  build: {
    rollupOptions: {
      input: {
        ...
        identiteVisuelle: resolve(__dirname, 'identite-visuelle.html'),
        supportsImprimes: resolve(__dirname, 'supports-imprimes.html'),
        creationVideo: resolve(__dirname, 'creation-video.html'),
